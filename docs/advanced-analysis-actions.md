---
slug: trend-vision-one-advanced-analysis-actions
...
- [Execution Profile](execution-profile.md "View objects and events using a dynamic and interactive visualization.")
- [Network analytics report](network-analytics-report.md "The network analytics report shows network correlations between the trigger object selected in Observable Graph and other related objects.")
