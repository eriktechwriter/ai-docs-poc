...
3.  Configure the Trend Vision One integration in Elastic.
    ...
    3.  Click **Add System**.
        ...
        For more information, see [Elastic documentation](https://www.elastic.co/guide/en/starting-with-the-elasticsearch-platform-and-its-solutions/8.12/getting-started-observability.md).
