...
title: Creating Automated Response Playbooks
---
...
Automated Response Playbooks (formerly Automated Response) allow you to automate your response to [Workbench](workbench.md) alerts by leveraging the [Security Playbooks](security-playbooks.md) app.
...
4.  On the **Trigger Settings** panel, select **Automatic or manual (executed from Workbench)** or **Manual (executed from Workbench)** for the trigger type and click **Apply**.
    ...
    For more information about how to trigger playbook execution from Workbench, see [All Alerts](all-alerts.md) and [Workbench Insights alerts](alerts-workbench-insights.md) in the Workbench documentation.
...
5.  On the **Target Settings** panel, select and configure the **Target** for the playbook and click **Apply**.
    ...
    3.  If you want the playbook to open a case for the Workbench alert that meets the conditions, select **Open a Workbench case**, assign a maximum of 50 owners to the alert, and specify whether to automatically close the case when the playbook executes successfully.
...
6.  If you need to take actions when specific conditions are met, configure the **Condition** node.
    ...
    2.  Create a condition setting by specifying the **Parameter**, **Operator**, and **Value**.
        ...
        <p>This is a pre-release sub-feature and is not part of the existing features of an official commercial or general release. Please review the <a href="trend-vision-one-pre-release-sub-feature-disclaimer">Pre-release sub-feature disclaimer</a> before using the sub-feature.</p>
...
7.  Configure actions by adding an **Action** node.
    ...
    2.  On the **Action Settings** panel, select **Workbench alert** and configure the automated response actions taken on the "highly suspicious", "suspicious" and/or "unrated" objects.
        ...
        Response actions require that you have configured the supporting services. For more information, see [Response Actions](response-actions-section.md).
        ...
        <td><ul>
        <li><p><strong>Add to Block List</strong>: Adds objects to the User-Defined Suspicious Objects List</p></li>
        </ul></td>
        </tr>
        <tr>
        ...
        <p>This action is only available for AWS accounts with the <strong>Cloud Response for AWS</strong> feature enabled.</p>
