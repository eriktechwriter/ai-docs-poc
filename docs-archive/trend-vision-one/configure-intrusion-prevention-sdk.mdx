...
When designing the module’s behavior and implementing it using the API, use the background information and guidance that is provided in [About Intrusion Prevention](intrusion-prevention.mdx).
