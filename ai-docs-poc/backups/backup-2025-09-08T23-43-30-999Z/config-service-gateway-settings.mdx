...
ai_context:
  source_file: config-service-gateway-settings.md
  conversion_date: '2025-09-08T23:42:22.929Z'
...
3.  On the **General** tab, configure the following settings based on your network requirements.
    ...
    <td><p>Set the pattern and preferred time to update the Service Gateway appliance and the services installed the appliance</p>
    <p>Select one of the following update patterns:</p>
    <ul>
    <li><p>Update the appliance and installed services to the latest version</p></li>
    <li><p>Update the appliance to the latest version that is at least X days old</p></li>
    </ul>
    ...
    <p>If you select <strong>Update the appliance and installed services to the latest version</strong>, the Service Gateway begins to update the appliance and any services installed on the appliance to the latest version at the next occurrence of the preferred update time following the version release date. To update as soon as possible, select every day when specifying the preferred update time.</p>
    <p>If you select <strong>Update the appliance to the latest version that is at least X days old</strong>, once the latest appliance version is released and the specified number of days have passed, the Service Gateway updates to that version at the next occurrence of the preferred update time. Select <strong>Also apply this delay to any installed services</strong> if you want the installed services to follow the same delay period before being updated.</p>
    ...
    <p>For more information, see <a href="trend-vision-one-cloud-service-extension">Cloud service extension</a>.</p>
...
- [Cloud service extension](cloud-service-extension.md "Reduce your firewall requirements and filter Trend Vision One traffic with the cloud service extension for Service Gateway.")
