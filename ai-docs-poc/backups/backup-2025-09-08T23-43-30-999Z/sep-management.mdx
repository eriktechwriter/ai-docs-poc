...
ai_context:
  source_file: sep-management.md
  conversion_date: '2025-09-08T23:42:12.880Z'
...
<ul>
<li><p>You can create up to five Standard Endpoint Protection Managers from the Product Instance app. There is no limit to the number of instances you can create from updating connected products. For more information, see <a href="trend-vision-one-creating-new-product-instance">Create a new product instance</a>.</p></li>
</ul></td>
</tr>
<tr>
