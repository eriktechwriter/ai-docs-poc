---
slug: trend-vision-one-integrate-aws-services
title: Integrate Server & Workload Protection with AWS Services
last_updated: '2025-09-08'
ai_context:
  source_file: integrate-aws-services.md
  conversion_date: '2025-09-08T23:42:17.139Z'
...
![](/images/aws-service-integration-pattern=00a0fa66-2ba9-4045-9098-9284a765eef3.webp)
...
The [Amazon GuardDuty](https://aws.amazon.com/guardduty/) service continuously monitors VPC flow logs, Amazon CloudTrail logs, and custom IP lists for issues and threats that may impact your AWS account.
...
[Amazon Macie](https://aws.amazon.com/macie/) (in limited release) examines the contents of Amazon S3 buckets to discover, classify, and protect sensitive data. Macie finds personally identifiable information (PII) or sensitive corporate data and highlights that risk.
...
[Amazon Inspector](https://aws.amazon.com/inspector/) is an automated security assessment service that can help improve the security and compliance of your EC2 instances and ECS hosts. Inspector runs as an agent on the instance and generates a report as a result of an assessment request.
...
[AWS WAF](https://aws.amazon.com/waf/) is a web application firewall that runs on the 120+ points of presence that make up the AWS Edge. WAF examines layer 7 web requests to discover common web-based attacks.
...
- [Managed rules for web servers](https://aws.amazon.com/marketplace/pp/Trend-Micro-Trend-Micro-Managed-Rules-for-AWS-WAF-/B0779NQYMZ)
- [Managed rules for content management systems](https://aws.amazon.com/marketplace/pp/B0779N3B6Q)
