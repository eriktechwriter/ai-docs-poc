---
slug: trend-vision-one-how-works
title: How Cloud Email and Collaboration Protection works
last_updated: '2025-09-08'
ai_context:
  source_file: how-works.md
  conversion_date: '2025-09-08T23:42:18.102Z'
...
In addition to API-based Protection, Cloud Email and Collaboration Protection also provides the option of Inline Protection for email services to block security risks before they can affect your organization. For details, see [Protection modes for email services](protection-modes-for-email-services.mdx).
:::
...
<figure>
<img src="./images/Cloud_App_Security_Architecture_Diagram=GUID-0E7ABDAE-BABD-4D7A-962D-2C38275A7740=11=en-us=Low.webp" />
</figure>

**Related information**

- [Protection modes for email services](protection-modes-for-email-services.mdx)
::::
