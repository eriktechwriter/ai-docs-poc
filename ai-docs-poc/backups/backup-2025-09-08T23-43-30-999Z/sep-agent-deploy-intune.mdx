---
slug: trend-vision-one-sep-agent-deploy-intune
title: Standard Endpoint Protection Agent Deployment using Microsoft Intune
last_updated: '2025-09-08'
ai_context:
  source_file: sep-agent-deploy-intune.md
  conversion_date: '2025-09-08T23:42:12.887Z'
conversion_status: converted
translation_ready: true
---

::::: {role="main"}
Deploy the Standard Endpoint Protection agent to your endpoints using Microsoft Intune.
...
For Standard Endpoint Protection agents, you can set up the [agent for VDI environments](create-golden-agent-image.mdx) if your network includes virtual desktops.
:::
...
3.  Specify the **Standard Endpoint Protection** package settings.

    1.  Select the **Windows** operating system.

    2.  Select **x86_64** for the **OS architecture**.

    3.  Select the **Endpoint Group Manager** that the newly-deployed agents report to.
...
12. Specify a unique **Name** for the app.
    ...
    Trend Micro recommends using a name which includes the agent information, such as `Trend Vision One Standard Endpoint Agent.`
...
16. Configure the **Program** tab and click **Next**.
    ...
    - **Uninstall command**: Type `msiexec /x {1841AFE1-4BA7-44D4-8700-6ACF860A8ED1} /q`
...
20. Click **Add** to add new detection rules.
    ...
    <td><p>MSI</p></td>
    <td><ul>
    <li><p><strong>MSI product code</strong>: Type <code>{1841AFE1-4BA7-44D4-8700-6ACF860A8ED1}</code></p></li>
    <li><p><strong>MSI product version check</strong>: Select <strong>No</strong>.</p></li>
    </ul></td>
    </tr>
    <tr>
    <td><p>File</p></td>
