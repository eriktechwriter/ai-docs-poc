...
ai_context:
  source_file: service-gateway-cli-commands.md
  conversion_date: '2025-09-08T23:42:12.822Z'
...
For customers using the previous Service Gateway 1.0 version, check the [Service Gateway 1.0 CLI commands](service-gateway-1-0-cli-commands.mdx).
...
<tr>
<td rowspan="11"><p><code>configure route</code></p></td>
...
<tr>
<td><p><code>configure route ipv4.default primary</code></p></td>
<td><p>Configure the primary network interface as the default IPv4 route for the Service Gateway virtual appliance</p></td>
</tr>
<tr>
...
<tr>
<td><p><code>configure route ipv6.default additional</code></p></td>
<td><p>Configure the additional network interface as the default IPv6 route for the Service Gateway virtual appliance</p></td>
</tr>
<tr>
<td><p><code>configure route ipv6.default primary</code></p></td>
<td><p>Configure the primary network interface as the default IPv6 route for the Service Gateway virtual appliance</p></td>
</tr>
</tbody>
</table>
...
- [Service Gateway 1.0 CLI commands](service-gateway-1-0-cli-commands.md "A list of available CLI commands for managing the Service Gateway 1.0 virtual appliance.")
::::
