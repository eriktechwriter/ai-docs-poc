---
slug: trend-vision-one-deploy-iac-onpremises-gateway
title: Deploying an Internet Access On-Premises Gateway
last_updated: '2025-09-08'
ai_context:
  source_file: deploy-iac-onpremises-gateway.md
  conversion_date: '2025-09-08T23:42:20.664Z'
...
- [Configuring upstream proxy rules](configuring-upstream-proxy-rules.md "Set up rules for user web activity traffic using upstream proxies on your Internet Access On-Premises Gateway.")
- [Configuring bandwidth control](configuring-bandwidth-control.md "Reduce network congestion on your on-premises gateway by configuring bandwidth control.")
- [Configuring reverse proxy mode](configuring-reverse-proxy-mode.md "Configure reverse proxy mode on an Internet Access On-Premises Gateway in order to secure the use of your private general or generative AI applications.")
- [Enable FTP proxy on an Internet Access On-premises gateway](ftp-proxy-internet-premises-gateway.mdx)
- [Syslog content mapping - CEF](syslog-content-mapping-cef-ztsa.md "Understand the content mapping between Internet Access log output and CEF syslog format.")
::::
