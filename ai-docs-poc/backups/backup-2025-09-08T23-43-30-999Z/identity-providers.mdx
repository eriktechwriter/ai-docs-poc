...
ai_context:
  source_file: identity-providers.md
  conversion_date: '2025-09-08T23:42:17.740Z'
...
3.  Go to your IdP to configure the settings and download the IdP metadata XML file.
    ...
    - [Configure OneLogin](configuring-onelogin.mdx)
...
7.  (Optional) Configure the IdP to support adding [IdP-Only SAML Group Account](adding-idp-only-saml-group-account.mdx) users by specifying attributes provided in the IdP system.
...
- [Configure Active Directory Federation Services](configuring-adfs.md "Configure Active Directory Federation Services (AD FS) as a SAML (2.0) identity provider for Trend Vision One.")
- [Configure Google Cloud Identity](config-google-cloud-saml.md "Configure Google Cloud Identity to serve as a SAML (2.0) identity provider for use by Trend Vision One.")
- [Configure Microsoft Entra ID](configuring-saml-ad.md "Configure Microsoft Entra ID as a SAML (2.0) identity provider for Trend Vision One to use.")
- [Configure Okta](configuring-okta-saml.md "Configure Okta as a SAML (2.0) identity provider for Trend Vision One to use.")
- [Configure OneLogin](configuring-onelogin.md "Configure OneLogin as a SAML (2.0) identity provider for Trend Vision One.")
:::
