---
slug: trend-vision-one-restore-message-task
title: Restore Message task
last_updated: '2025-09-08'
ai_context:
  source_file: restore-message-task.md
  conversion_date: '2025-09-08T23:42:13.708Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
Restore a quarantined email message to the selected mailboxes using context menus on the Trend Vision One console.
...
1.  After locating the quarantined email message, access the context or response menu and click **Restore Message**.

    The **Restore Message Task** screen appears.
...
6.  Click **Restore Message** to confirm the task.
...
7.  Monitor the task status.
    ...
    2.  (Optional) Locate the task using the **Search** field or by selecting **Restore Message** from the **Action** drop-down list.
