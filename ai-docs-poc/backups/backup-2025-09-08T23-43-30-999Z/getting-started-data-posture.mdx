---
slug: trend-vision-one-getting-started-data-posture
title: Get started with Data Security Posture
last_updated: '2025-09-08'
ai_context:
  source_file: getting-started-data-posture.md
  conversion_date: '2025-09-08T23:42:18.820Z'
...
- [Enable Data Security Posture for your AWS cloud accounts](data-posture-for-aws-accounts.mdx)
- [Enable Data Security Posture on an Azure subscription](data-security-posture-azure.mdx)
- [Enable or disable Data Security Posture for cloud storage assets](enable-or-disable-data-posture.mdx)
- [Enable Amazon Macie](enable-amazon-macie.mdx)
:::
