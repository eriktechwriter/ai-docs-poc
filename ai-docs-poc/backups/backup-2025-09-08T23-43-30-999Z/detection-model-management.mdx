...
ai_context:
  source_file: detection-model-management.md
  conversion_date: '2025-09-08T23:42:20.559Z'
...
**Detection Model Management** (**Agentic SIEM & XDR → Detection Model Management**) enables you to configure how Trend Vision One detects events in Observed Attack Techniques and generates alerts in Workbench.
...
<td><p>View all predefined detection models provided by Trend Vision One</p></td>
</tr>
<tr>
<td><p><a href="trend-vision-one-custom-models">Custom Models</a></p></td>
<td><ul>
<li><p><a href="trend-vision-one-configuring-custom-model">Create</a>, manage, edit, import, and export custom detection models</p></li>
...
<td><ul>
<li><p><a href="trend-vision-one-creating-custom-filter">Create</a>, manage, edit, import, and export custom filters</p></li>
