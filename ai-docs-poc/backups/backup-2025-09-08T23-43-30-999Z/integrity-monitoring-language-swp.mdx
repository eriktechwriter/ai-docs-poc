---
slug: trend-vision-one-integrity-monitoring-language-swp
title: About the Integrity Monitoring rules language
last_updated: '2025-09-08'
ai_context:
  source_file: integrity-monitoring-language-swp.md
  conversion_date: '2025-09-08T23:42:17.063Z'
...
If you only need to monitor for unauthorized changes to files or the Windows registry, you can use File and Registry rule templates instead of creating a custom one. For more information on using these templates, see [Create an integrity monitoring rule](create-integrity-monitoring-rule.mdx).
:::

To create a new custom Integrity Monitoring rule, start with the procedure in [Create an integrity monitoring rule](create-integrity-monitoring-rule.mdx) (selecting *Custom (XML)* as the template type), then create your custom rule according to the Integrity Monitoring rules language, as covered in the following sections:
...
- [DirectorySet](directoryset.mdx): rules will scan the integrity of directories
- [FileSet](fileset.mdx): rules will scan the integrity of files
- [GroupSet](groupset.mdx): rules will scan the integrity of groups
- [InstalledSoftwareSet](installedsoftwareset.mdx): rules will scan the integrity of installed software
- [PortSet](portset.mdx): rules will scan the integrity of listening ports
- [ProcessSet](processset.mdx): rules will scan the integrity of processes
- [RegistryKeySet](registrykeyset.mdx): rules will scan registry keys
- [RegistryValueSet](registryvalueset.mdx): rules will scan registry values
- [ServiceSet](serviceset.mdx): rules will scan the integrity of services
- [UserSet](userset.mdx): rules will scan the integrity of users
- [WQLSet](wqlset.mdx): rules will monitor the integrity of the results of a [Windows Management Instrumentation](https://docs.microsoft.com/en-us/windows/win32/wmisdk/wmi-start-page?redirectedfrom=MSDN) WQL query statement
...
### Hierarchies and wildcards {#hierarchies-and-wildcards}
...
### Syntax and concepts {#syntax-and-concepts}
...
<tr>
<td><p>STANDARD</p></td>
<td><p>The set of attributes to monitor for the Entity Set. This is different than "every possible attribute" for the Entity Set. For example, it would not include every possible hash algorithm, just the ones deemed sufficient. For the list of "standard" attributes for each Entity Set, see sections for the individual Entity Sets.</p></td>
</tr>
<tr>
<td><p>CONTENTS</p></td>
<td><p>This is Shorthand for the hash, or set of hashes, of the contents of the file. Defaults to SHA-1.</p></td>
</tr>
</tbody>
</table>
...
<td><p>C:\ProgramData</p></td>
</tr>
<tr>
<td><p>COMMONPROGRAMFILES</p></td>
<td><p>C:\Program Files\Common Files</p></td>
</tr>
<tr>
...
Any of these statements in your integrity monitoring rules will cause performance issues as the agent searches through many items in order to match the specified patterns.
::::::::::::::
