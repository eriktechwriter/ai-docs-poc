...
ai_context:
  source_file: microsoft-sentinel-integration.md
  conversion_date: '2025-09-08T23:42:16.038Z'
...
2.  Configure and deploy the connector.
    ...
    For more information, see [Deploy the Trend Vision One connector in Microsoft Sentinel](deploying-connector.mdx).

3.  View the ingested data in your Log Analytics workspace.

    For more information, see [View the ingested data in Log Analytics workspaces](ingested-log-analytics-workspaces.mdx).

**Related information**

- [Deploy the Trend Vision One connector in Microsoft Sentinel](deploying-connector.md "Deploy the connector using Azure Functions to enable alert data collection from Trend Vision One.")
