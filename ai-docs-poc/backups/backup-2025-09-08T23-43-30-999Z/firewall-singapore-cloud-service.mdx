...
ai_context:
  source_file: firewall-singapore-cloud-service.md
  conversion_date: '2025-09-08T23:42:19.119Z'
conversion_status: converted
translation_ready: true
---

:::: {role="main"}
The following firewall exceptions apply to networks with a Service Gateway installed and [cloud service extension](cloud-service-extension.mdx) turned on.
...
<td><p>Singapore</p></td>
<td><p>Refer to the Deep Discovery Inspector exceptions in <a href="trend-vision-one-firewall-singapore-all-global">Firewall exceptions: Singapore - all exceptions</a>.</p></td>
</tr>
</tbody>
</table>
::::
