...
ai_context:
  source_file: deploy-agents-using-sccm.md
  conversion_date: '2025-09-08T23:42:20.705Z'
...
7.  Unzip the Agent Package and move the contents to the Configuration Manager server.
...
8.  Create the package.
    ...
    12. Select the specified platforms based on the [system requirements](endpoint-agent-system-requirements.mdx) of the agent you are deploying and the needs of your security environment.
...
9.  Upload the package to distribution points.
