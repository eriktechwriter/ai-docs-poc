...
ai_context:
  source_file: obtain-api-keys-third-party.md
  conversion_date: '2025-09-08T23:42:14.868Z'
...
2.  Add an account for the third-party auditor.
    ...
    3.  Select an **Account type**.
        ...
        - You must configure Single Sign-on to select "SAML account" as an account type. For more information, see [Configure accounts](configure-vision-accounts.mdx).
