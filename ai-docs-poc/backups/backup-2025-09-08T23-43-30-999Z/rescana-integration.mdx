...
ai_context:
  source_file: rescana-integration.md
  conversion_date: '2025-09-08T23:42:13.790Z'
...
2.  Add the appropriate Trend Vision One [regional IP addresses](asrm-regional-ip-addresses.mdx) to the list of trusted IP addresses in the Rescana console.
