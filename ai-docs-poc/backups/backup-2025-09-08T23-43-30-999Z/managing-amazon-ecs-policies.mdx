...
ai_context:
  source_file: managing-amazon-ecs-policies.md
  conversion_date: '2025-09-08T23:42:16.180Z'
...
Policy configuration for Kubernetes clusters differs greatly from a Amazon ECS environment. To properly configure Kubernetes protection policies, see [Managing Kubernetes protection policies](kubernetes-protection-policies.mdx).
:::
