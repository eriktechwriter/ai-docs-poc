---
slug: trend-vision-one-automation-integration-apis
title: Automation and integration APIs
last_updated: '2025-09-08'
ai_context:
  source_file: automation-integration-apis.md
  conversion_date: '2025-09-08T23:42:24.635Z'
...
For more information on the supported APIs and how to implement them, see [Cloud Email and Collaboration Protection Automation and Integration API Online Help](https://docs.trendmicro.com/en-us/documentation/article/cloud-app-security-v1ecs-integration-api-online-help-getting-started-with).
:::
