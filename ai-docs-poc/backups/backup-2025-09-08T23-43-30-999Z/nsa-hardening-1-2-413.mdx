---
slug: trend-vision-one-nsa-hardening-1-2-413
title: >-
  4.1.3 - Minimize the admission of containers configured to share the host IPC
  namespace (Automated)
last_updated: '2025-09-08'
ai_context:
  source_file: nsa-hardening-1-2-413.md
  conversion_date: '2025-09-08T23:42:14.936Z'
...
This command retrieves all pods across all namespaces in JSON format, then uses jq to filter out those with the `hostIPC` flag set to `true`, and finally it formats the output to show the namespace and name of each matching pod.
