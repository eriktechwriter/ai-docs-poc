...
ai_context:
  source_file: openldap-integration.md
  conversion_date: '2025-09-08T23:42:14.764Z'
...
At least one [Service Gateway](service-gateway-management.mdx) (version 2.0 and above) must be configured to enable integration.
:::
