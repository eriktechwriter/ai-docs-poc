---
slug: trend-vision-one-resource-update-azure-subscriptions
title: Azure Resource Update
last_updated: '2025-09-08'
ai_context:
  source_file: resource-update-azure-subscriptions.md
  conversion_date: '2025-09-08T23:42:13.775Z'
...
The Resource Update tab in the Subscription Settings screen allows you to update the Trend Vision One resources deployed to your subscription. This may be required as support for new features or functions are added to Cloud Accounts. Make sure you have the [required permissions](azure-required-granted-permissions.mdx) to update the subscription.

:::warning[Important]

The steps are valid for Azure Cloud Shell as of January 2025.
:::
...
8.  Access the folder where the resource is located.
    ...
    Copy the command or type `cd [Subscription ID]`.
...
10. Extract the template using the command in the **Subscription Settings** screen.
...
11. Access the deployment folder.
...
13. In the Trend Vision One console, after the progress completes, close the **Subscription Settings** screen.

    The update process can take several moments to complete. You can refresh the Cloud Accounts screen to check the status of your update.
::::
