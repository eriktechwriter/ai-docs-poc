---
slug: trend-vision-one-network-sensor-vmware-esxi
title: Deploying a Virtual Network Sensor with VMware ESXi
last_updated: '2025-09-08'
ai_context:
  source_file: network-sensor-vmware-esxi.md
  conversion_date: '2025-09-08T23:42:15.331Z'
...
6.  In the VMware ESXi console, [configure network settings](exttraffic-vsphere-st-promiscuous.mdx) to allow Virtual Network Sensor to monitor data in VMware ESXi.

7.  On the VMware ESXi console, go to **Virtual Machines → Create / Register VM**.
...
18. To confirm that your Virtual Network Sensor has successfully deployed, go to **Network Security → Network Inventory → Virtual Network Sensor** on the Trend Vision One console to view information about your deployed Virtual Network Sensor.
...
- [Configuring External Network Traffic with the VMware vSphere Standard Switch (Promiscuous Mode)](exttraffic-vsphere-st-promiscuous.md "Configure network settings in VMware ESXi to allow Virtual Network Sensor to monitor data.")
:::::
