---
slug: trend-vision-one-rank-events-importance
title: Rank events to quantify their importance
last_updated: '2025-09-08'
ai_context:
  source_file: rank-events-importance.md
  conversion_date: '2025-09-08T23:42:13.949Z'
...
### Web Reputation event risk values {#web-reputation-event-risk-values}
...
### Firewall rule severity values {#firewall-rule-severity-values}
...
### Intrusion Prevention rule severity values {#intrusion-prevention-rule-severity-values}
...
### Integrity Monitoring rule severity values {#integrity-monitoring-rule-severity-values}
...
### Log Inspection rule severity values {#log-inspection-rule-severity-values}
