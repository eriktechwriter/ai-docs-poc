...
ai_context:
  source_file: search-identifier-element.md
  conversion_date: '2025-09-08T23:42:13.082Z'
...
<p>Use the field names defined for each <a href="trend-vision-one-search-method-data-sources">data source</a> to create objects.</p>
...
<li><p><a href="trend-vision-one-trend-micro-sigma-specification">Trend Micro Sigma specification</a> allows the following special modifiers for searching strings:</p>
<ul>
