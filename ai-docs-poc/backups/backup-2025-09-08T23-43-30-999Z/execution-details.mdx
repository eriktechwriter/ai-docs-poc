...
ai_context:
  source_file: execution-details.md
  conversion_date: '2025-09-08T23:42:19.553Z'
...
<tr>
<td><p>Download a CSV file</p></td>
<td><p>Click <strong>Download file</strong> to download a CSV detailing the results of the playbook execution up to the selected node.</p>


:::note

<p><strong>Download file</strong> is only displayed if the selected node is configured to generate a CSV file.</p>
