...
title: Create Service Gateway configuration profiles
last_updated: '2025-09-08'
ai_context:
  source_file: create-sg-config-profile.md
  conversion_date: '2025-09-08T23:42:21.375Z'
...
5.  Configure settings for a configuration profile.
    ...
    <p>For information on the configuration steps, see <a href="trend-vision-one-config-service-gateway-settings">Configure Service Gateway settings</a>.</p></li>
    </ol></td>
    </tr>
    <tr>
