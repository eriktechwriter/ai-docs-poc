---
slug: trend-vision-one-overview-section-policy-editor
title: Overview section of the policy editor
last_updated: '2025-09-08'
ai_context:
  source_file: overview-section-policy-editor.md
  conversion_date: '2025-09-08T23:42:14.681Z'
...
### Computer(s) Using This Policy tab {#computers-using-this-policy-tab}
...
The current supported USB device exception rule count for each policy is 1000.
:::
