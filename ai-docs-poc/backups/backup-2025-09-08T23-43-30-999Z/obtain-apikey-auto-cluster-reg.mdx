---
slug: trend-vision-one-obtain-apikey-auto-cluster-reg
title: Obtain an API key for automated cluster registration
last_updated: '2025-09-08'
ai_context:
  source_file: obtain-apikey-auto-cluster-reg.md
  conversion_date: '2025-09-08T23:42:14.864Z'
...
Contact your Trend Vision One administrator to [obtain an API key](platform-api-keys.mdx) and [enable the Automatically register cluster permission on the related user role](custom-user-roles-trend-vision-one.mdx).

:::note

After Container Security is uninstalled, automatically registered clusters are unregistered when their retention period is reached.
:::
