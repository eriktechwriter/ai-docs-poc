...
title: >-
  Running simulations on endpoints manged by connected endpoint protection
  products
last_updated: '2025-09-08'
ai_context:
  source_file: simulations-endpoint-sensor.md
  conversion_date: '2025-09-08T23:42:12.464Z'
...
The following steps detail how to connect Trend Micro Apex One as a Service and Trend Cloud One - Endpoint & Workload Security instances, and run simulations. To run simulations on endpoints with a deployed Trend Vision One Endpoint Security agent with Standard Endpoint Protection or Server & Workload Protection, see [Running simulations with Trend Vision One Endpoint Security agents](running-simulations-endpoints-xdr.mdx).

To run simulations on a Deep Security Agent without the Trend Vision One Endpoint Security agent, see [Running simulations on Deep Security Agents endpoints with Activity Monitoring](simulations-deep-security-agents.mdx).

To evaluate Trend Vision One without connecting your endpoint protection products, you can move your endpoints to Standard Endpoint Protection or Server & Workload Protection. For more information, see [Evaluate Trend Vision One Endpoint Security](evaluate-endpoint-security.mdx).
...
1.  Connect your endpoint protection management console in **Product Instance**.
    ...
    For more information, see [Connect existing products to Product Instance](connect-exist-prod-instance.mdx) .
...
2.  Deploy the Trend Vision One Endpoint Security agent to connected endpoints.
    ...
    - For Trend Cloud One - Endpoint & Workload Security, install the Trend Vision One Endpoint Security agent through the management console. For more information, see [Install Trend Vision One Endpoint Security agent via Deep Security Agent](https://docs.trendmicro.com/en-us/documentation/article/trend-micro-cloud-one-workload-security-agent-v1-install).
