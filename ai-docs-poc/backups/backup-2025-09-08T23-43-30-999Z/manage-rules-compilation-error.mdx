---
slug: trend-vision-one-manage-rules-compilation-error
title: Manage rules
last_updated: '2025-09-08'
ai_context:
  source_file: manage-rules-compilation-error.md
  conversion_date: '2025-09-08T23:42:16.223Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
The Intrusion Prevention Rule Compilation Failed error can occur when the number of assigned Intrusion Prevention rules exceeds the recommended count. You should not have more than 400 Intrusion Prevention rules on an endpoint. Trend Micro recommends only applying the Intrusion Prevention rules that a [recommendation scan](recommendation-scans-intro.mdx) suggests to avoid applying unnecessary rules. If you are applying Intrusion Prevention rules manually, apply them to the computer rather than the policy to avoid adding too many application types to a single port.
...
5.  Select one or more rules to unassign.
