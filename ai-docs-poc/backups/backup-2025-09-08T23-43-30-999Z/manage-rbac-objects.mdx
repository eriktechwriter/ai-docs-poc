---
slug: trend-vision-one-manage-rbac-objects
title: Manage role-based access control for common objects
last_updated: '2025-09-08'
ai_context:
  source_file: manage-rbac-objects.md
  conversion_date: '2025-09-08T23:42:16.225Z'
...
You can set up user roles and asset visibility scope by accessing the [User Roles](user-roles-foundation-services.mdx) screen and applying roles in the [User Accounts](user-accounts-foundation-services.mdx) screen.
...
Permissions applied to an object will also apply to other objects of the same type.
:::
::::
