---
slug: trend-vision-one-cis-gke17-4110b
title: '4.1.10 - Avoid non-default bindings to system:authenticated (Automated)'
last_updated: '2025-09-08'
ai_context:
  source_file: cis-gke17-4110b.md
  conversion_date: '2025-09-08T23:42:23.676Z'
...
Identify all non-default `clusterrolebindings` and `rolebindings` to the group `system:authenticated`. Check if they are used and review the permissions associated with the binding using the commands in the Audit section above or refer to [GKE documentation](https://cloud.google.com/kubernetes-engine/docs/best-practices/rbac).
