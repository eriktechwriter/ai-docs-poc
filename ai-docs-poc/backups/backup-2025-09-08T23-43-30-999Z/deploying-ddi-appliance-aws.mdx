...
ai_context:
  source_file: deploying-ddi-appliance-aws.md
  conversion_date: '2025-09-08T23:42:20.609Z'
...
12. Wait for the Deep Discovery Inspector virtual appliance to become ready.
    ...
    1.  View the Deep Discovery Inspector installation progress by using the following steps:
        ...
        For more information, see [https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/launching-instance.html](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/launching-instance.mdx).
...
15. Configure the Deep Discovery Inspector virtual appliance.
    ...
    - Review [sandbox options](sandbox-deep-discovery-inspector.mdx) for collecting and analyzing suspicious objects.

    - [Manage settings from Network Inventory](deep-discovery-inspector-appliances.mdx) such as enabling the Network Sensor and connecting to a Service Gateway.
