...
ai_context:
  source_file: suspicious-object-actions.md
  conversion_date: '2025-09-08T23:42:12.209Z'
...
Trend Vision One connects to different products and sends the Suspicious Object List to the connected products for detection. The connected products then apply the specified action based on their capability.
...
<tbody>
<tr>
<td rowspan="6"><p>Trend Vision One Endpoint Security agent - Endpoint detection and response</p>
<p>(Windows)</p></td>
...
<p>The Log and Block actions for File SHA-1 and File SHA-256 are only supported for PE and ELF file formats.</p>
<p>The Block action for URL and Domain requires enabling the browser extension in endpoint security policies. For more information, see <a href="trend-vision-one-configuring-endpoint-policies">Configure endpoint security policies</a>.</p>
...
<p>The Log and Block actions for File SHA-1 and File SHA-256 are only supported for MACH-O file formats.</p>
...
<tr>
<td rowspan="3"><p>Trend Vision One Endpoint Security agent - Endpoint detection and response</p>
<p>(Linux)</p></td>
<td><p>File SHA-1</p></td>
...
<tr>
<td rowspan="6"><p>Trend Vision One Endpoint Security agent with Standard Endpoint Protection</p>
<p>(Windows)</p></td>
<td><p>IP address</p></td>
<td rowspan="5"><p>Log, Block</p></td>
</tr>
...
<ul>
<li><p>To take action on File SHA-1 and SHA-256 objects, you must first activate Application Control for Standard Endpoint Protection.</p></li>
<li><p>The Log and Block actions for File SHA-1 and SHA-256 objects are only supported for PE and ELF file formats.</p></li>
</ul>
...
<p>The connected products of Service Gateway apply the specified action based on their capability. For the list of connected products, see <a href="trend-vision-one-configure-service-gateway-setting">Configure Service Gateway settings</a>.</p>
...
<tr>
<td rowspan="6"><p>Trend Micro Apex One as a Service</p></td>
<td><p>IP address</p></td>
<td rowspan="5"><p>Log, Block</p></td>
</tr>
<tr>
...
<ul>
<li><p>To take action on File SHA-1 and SHA-256 objects, you must first activate Application Control for Trend Micro Apex One as a Service.</p></li>
<li><p>The Log and Block actions for File SHA-1 and SHA-256 objects are only supported for PE and ELF file formats.</p></li>
</ul>
...
<tr>
<td rowspan="6"><p>Trend Micro Apex One (on-premises)</p></td>
<td><p>IP address</p></td>
<td rowspan="5"><p>Log, Block</p></td>
</tr>
<tr>
...
<ul>
<li><p>To take action on File SHA-1 and SHA-256 objects, you must first activate Application Control for Trend Micro Apex One (on-premises).</p></li>
<li><p>The Log and Block actions for File SHA-1 and SHA-256 objects are only supported for PE and ELF file formats.</p></li>
</ul>
