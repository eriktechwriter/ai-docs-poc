---
slug: trend-vision-one-restore-connection-task-ztsa
title: Restore Connection task
last_updated: '2025-09-08'
ai_context:
  source_file: restore-connection-task-ztsa.md
  conversion_date: '2025-09-08T23:42:13.717Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
After resolving the risk issues on the isolated endpoint, you can restore network connectivity using the **Zero Trust Secure Access** or **Threat and Exposure Management** app.

### Procedure {#procedure}

1.  Locate the isolated endpoint using the **Zero Trust Secure Access** or **Threat and Exposure Management** app.
...
2.  Click the options icon (![](/images/options_icon=1b2aff71-0b33-4aa1-b8aa-6105438834e7.webp)) and **Restore Connection**.
