---
slug: trend-vision-one-deploy-pac-google-cloud-platform
title: Deploy the Private Access Connector on Google Cloud Platform
last_updated: '2025-09-08'
ai_context:
  source_file: deploy-pac-google-cloud-platform.md
  conversion_date: '2025-09-08T23:42:20.649Z'
...
7.  Install and [set up the Google Cloud SDK](https://cloud.google.com/sdk/docs/quickstart).
...
8.  Sign in to the [Google Cloud Platform](https://console.cloud.google.com/getting-started) as a super administrator.
...
15. Register the Private Access Connector virtual appliance to Trend Vision One.
    ...
    6.  Run the following command to register the Private Access Connector virtual appliance to Trend Vision One:
