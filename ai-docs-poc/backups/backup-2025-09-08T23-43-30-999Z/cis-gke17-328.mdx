---
slug: trend-vision-one-cis-gke17-328
title: >-
  3.2.8 - Ensure that the –rotate-certificates argument is not present or is set
  to true (Automated)
last_updated: '2025-09-08'
ai_context:
  source_file: cis-gke17-328.md
  conversion_date: '2025-09-08T23:42:23.679Z'
...
- This feature also requires the `RotateKubeletClientCertificate` feature gate to be enabled.
