---
slug: trend-vision-one-report-computer-status
title: Report on computer status
last_updated: '2025-09-08'
ai_context:
  source_file: report-computer-status.md
  conversion_date: '2025-09-08T23:42:13.837Z'
...
## Discover unprotected computers {#discover-unprotected-computers}
...
For background information about computer statuses, see [Computer and agent statuses](computer-agent-statuses.mdx)

## Find computers based on agent status {#find-computers-based-on-agent-status}
...
Also see the [List Computers](https://automation.trendmicro.com/cloudone/workload-security/), [Describe a Computer](https://automation.trendmicro.com/cloudone/workload-security/), and [Search Computers](https://automation.trendmicro.com/cloudone/workload-security/) operations in the API Reference.

## Find computers based on module status {#find-computers-based-on-module-status}
...
## Get computer configurations {#get-computer-configurations}
...
## Discover the Anti-Malware configuration of a computer {#discover-the-anti-malware-configuration-of-a-computer}
...
## Get applied intrusion prevention rules {#get-applied-intrusion-prevention-rules}
...
[View source](https://github.com/deep-security/automation-center-sdk-samples/blob/master/python/src/intrusion_prevention_examples.py)
...
Also see the [List Computers](https://automation.trendmicro.com/cloudone/workload-security/), [Describe a Computer](https://automation.trendmicro.com/cloudone/workload-security/), and [Search Computers](https://automation.trendmicro.com/cloudone/workload-security/) operations in the API Reference. For information about authenticating API calls, see [Authenticate with Server & Workload Protection](send-your-first-request-using-api.mdx).
:::::::
