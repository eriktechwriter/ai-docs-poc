---
slug: trend-vision-one-connect-alibaba-ack-clusters
title: Connect Alibaba Cloud ACK clusters
last_updated: '2025-09-08'
ai_context:
  source_file: connect-alibaba-ack-clusters.md
  conversion_date: '2025-09-08T23:42:21.975Z'
conversion_status: converted
translation_ready: true
---

:::: {role="main"}
Container Security supports protection on connected Alibaba Cloud ACK containers.
...
3.  Click **Deploy protection to a Kubernetes cluster** or **Add Cluster** if you already have clusters deployed.
...
6.  If you want Container Security to send data to Cloud Risk Management and receive [CREM Risk Insights](executive-dashboard.mdx), select **Map to cloud account**.
    ...
    1.  In the drop-down, select **Alibaba Cloud**.

    2.  In another browser tab, sign in to the Alibaba Cloud account that hosts the cluster.

    3.  Copy and paste the Region ID, Account ID, and Cluster ID for the cluster you want to protect, and enter the corresponding values under **Map to cloud account**.
