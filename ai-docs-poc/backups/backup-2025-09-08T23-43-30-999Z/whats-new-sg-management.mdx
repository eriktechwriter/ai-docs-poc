...
ai_context:
  source_file: whats-new-sg-management.md
  conversion_date: '2025-09-08T23:42:11.525Z'
...
Service Gateway Management brings a wealth of improvements and new features designed to make it even easier to manage connected services and products in your security environment compared to the previous [Service Gateway Management (Legacy) version](service-gateway-management-legacy.mdx).
