---
slug: trend-vision-one-artifact-scanner-tmas
title: Trend Micro Artifact Scanner (TMAS)
last_updated: '2025-09-08'
ai_context:
  source_file: artifact-scanner-tmas.md
  conversion_date: '2025-09-08T23:42:24.840Z'
...
- [Integrate Trend Micro Artifact Scanner (TMAS) into a CI/CD pipeline](integrating-tmas-ci-cd-pipeline.mdx)
- [Trend Micro Artifact Scanner and with AI Scanner](tmas-ai-scanner.mdx)
- [What to do after the Artifact Scanner scans](after-artifact-scanner.mdx)
- [Artifact Scanner CLI](artifact-scanner-cli.mdx)
- [Trend Micro Artifact Scanner (TMAS) Examples](tmas-examples.mdx)
:::
