---
slug: trend-vision-one-approved-blocked-ip-addresses
title: About approved and blocked IP addresses
last_updated: '2025-09-08'
ai_context:
  source_file: approved-blocked-ip-addresses.md
  conversion_date: '2025-09-08T23:42:24.862Z'
...
The IP addresses in the blocked lists are not subject to other IP reputation-based filtering. Cloud Email Gateway Protection permanently rejects connection attempts from such IP addresses by responding with a 550 error (a rejection of the requested connection).

**Related information**

- [Managing approved and blocked IP addresses](manage-approved-blocked-ips.mdx)
::::
