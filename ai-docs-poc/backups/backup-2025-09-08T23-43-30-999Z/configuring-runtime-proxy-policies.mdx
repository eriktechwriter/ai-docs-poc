...
ai_context:
  source_file: configuring-runtime-proxy-policies.md
  conversion_date: '2025-09-08T23:42:22.259Z'
...
- If you want to use a Service Gateway as a proxy, make sure to deploy and configure a Service Gateway with the Forward Proxy Service enabled. For more information, see [Deploy a Service Gateway and Configure Firewall Exceptions](deploy-service-gateway-exceptions.mdx).
