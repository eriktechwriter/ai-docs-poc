...
ai_context:
  source_file: firewall-americas-cloud-service.md
  conversion_date: '2025-09-08T23:42:19.181Z'
...
<td><p>Americas</p></td>
<td><p>Refer to the Deep Discovery Inspector exceptions in <a href="trend-vision-one-firewall-americas-all-exceptions">Firewall exceptions: Americas - all exceptions</a>.</p></td>
</tr>
</tbody>
</table>
::::
