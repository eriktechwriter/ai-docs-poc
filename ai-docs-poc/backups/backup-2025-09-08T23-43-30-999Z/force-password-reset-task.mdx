...
ai_context:
  source_file: force-password-reset-task.md
  conversion_date: '2025-09-08T23:42:19.086Z'
...
For more information, see [Assign the Password Administrator role](assigning-password-admin-role.mdx).
:::
