---
slug: trend-vision-one-force-password-reset-task-ztsa
title: Force Password Reset task
last_updated: '2025-09-08'
ai_context:
  source_file: force-password-reset-task-ztsa.md
  conversion_date: '2025-09-08T23:42:19.090Z'
...
2.  Click the options icon (![](/images/options_icon=1b2aff71-0b33-4aa1-b8aa-6105438834e7.webp)) and **Force Password Reset**.
...
6.  (Optional) Assign the password administrator role to Trend Vision One.
    ...
    1.  Sign in to the [Microsoft Azure](https://portal.azure.com) portal and assign the password administrator role to Trend Vision One.

        For more information, see [Assigning the password administrator role](assign-password-administrator-role.mdx).
...
- [Assigning the password administrator role](assign-password-administrator-role.md "Assign the Password Administrator role on the Microsoft Azure portal to Trend Vision One.")
:::
