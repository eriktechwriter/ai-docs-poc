...
ai_context:
  source_file: search-results.md
  conversion_date: '2025-09-08T23:42:13.078Z'
...
<tbody>
<tr>
<td><p>Switch between query result views</p></td>
...
<tr>
<td><p>View the data grouping and matched events of your query result detections</p></td>
...
<tr>
<td><p>Import query views</p></td>
<td><p>Click <strong>View</strong> and select <strong>Import Views</strong> to import one or more JSON files containing views.</p></td>
</tr>
</tbody>
</table>
...
- [Create a custom view for query results](custom-view-search-results.md "Create a custom view that defines how to display data grouping and query results.")
:::
