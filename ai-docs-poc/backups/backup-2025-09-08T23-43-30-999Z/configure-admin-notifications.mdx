...
ai_context:
  source_file: configure-admin-notifications.md
  conversion_date: '2025-09-08T23:42:22.897Z'
...
- [Response task](notifications-response-tasks.mdx)

- [New Workbench alert](notifications-workbench-alerts.mdx)

- [Private Access Connector status](notification-private-access.mdx)

- [Service Gateway critical service status or performance](notifications-sg.mdx)

- [New risk event](notifications-risk-event.mdx)

- [Case update summary](notification-case-update-summary.mdx)

- [Case update for owners](notifications-case-update-for-owner.mdx)

- [Newly discovered assets](notifications-new-assets.mdx)
