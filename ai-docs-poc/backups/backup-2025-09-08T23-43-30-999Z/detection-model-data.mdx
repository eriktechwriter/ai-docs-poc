...
ai_context:
  source_file: detection-model-data.md
  conversion_date: '2025-09-08T23:42:20.561Z'
...
If you enable an alert trigger, Trend Vision One starts to collect activity data from your supported products. To further check the alerts triggered by detection models, go to [Workbench](workbench.mdx).
:::
