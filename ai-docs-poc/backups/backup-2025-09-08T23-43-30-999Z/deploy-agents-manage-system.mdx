...
ai_context:
  source_file: deploy-agents-manage-system.md
  conversion_date: '2025-09-08T23:42:20.710Z'
...
- [Microsoft Intune](deploy-agents-ms-intune.mdx)

- [Microsoft Endpoint Configuration Manager (formerly System Center Configuration Manager)](deploy-agents-using-sccm.mdx)

- [Microsoft Active Directory Group Policy Object (GPO)](deploy-agents-gpo.mdx)
