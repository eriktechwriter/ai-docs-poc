---
slug: trend-vision-one-new-customers-apex-one-email
title: >-
  New Trend Vision One Customers Updating Apex One as a Service from an
  Activation Email
last_updated: '2025-09-08'
ai_context:
  source_file: new-customers-apex-one-email.md
  conversion_date: '2025-09-08T23:42:15.135Z'
...
2.  Sign in to Trend Vision One using the Primary User Account for your registered business.
...
6.  If your Primary User Account does not sign in using an email address, you must assign and verify the email address that will be used to access your update services.
...
7.  You must update the Primary User Account password.
...
11. Update your Apex One as a Service solution.

    1.  Go to **Service Management → Product Instance**.

    2.  Click **Add Existing Product**.

    3.  From **Instance type**, select **Trend Micro Apex One SaaS**.

    4.  Click the **Click to generate the enrollment token** link and copy the token.

    5.  Sign in to the Apex Central console.

    6.  Go to **Trend Vision One → Integration Settings**.

    7.  Paste the enrollment token you obtained from Product Instance in Trend Vision One.

    8.  Click **Register**.

        :::danger[Warning]

        After registering, the update process begins. You cannot undo or stop this action. After the update completes, you will no longer have access to your Apex Central console. You will still have access to the Apex One consoles that were managed by the retired Apex Central console.
        :::
