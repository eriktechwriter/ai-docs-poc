...
ai_context:
  source_file: alert-notifications.md
  conversion_date: '2025-09-08T23:42:25.325Z'
...
<p>The Audit Logs app creates notifications based on information from the Service Gateway Management, Network Inventory, Product Instance, and Zero Trust Secure Access apps.</p>
...
<td><p>Sends a notification after detecting new users or devices classified as high-risk within the past 4 hours</p>
<p>For more information, see <a href="trend-vision-one-attack-surface-discovery">Attack Surface Discovery</a>.</p></td>
</tr>
<tr>
<td><p>Risk control rule match</p></td>
<td><p>Zero Trust Secure Access</p></td>
<td><p>Sends a single email of the latest notifications after detecting a secure access rule match</p>
<p>For more information, see <a href="trend-vision-one-secure-access-rules">Secure access rules</a>.</p></td>
</tr>
<tr>
<td><p>Private Access Connector status</p></td>
<td><p>Zero Trust Secure Access</p></td>
<td><p>Sends a single email of the latest notifications when the status of Private Access Connectors changes to Unhealthy or Disconnected</p>
<p>For more information, see <a href="trend-vision-one-private-access-connector-config">Private Access Connector configuration</a>.</p></td>
</tr>
<tr>
...
<p>For more information, see <a href="trend-vision-one-corporate-network-locations-ia">Internet Access gateways and corporate network locations</a>.</p></td>
</tr>
<tr>
<td><p>Internet Access control rule detection</p></td>
<td><p>Zero Trust Secure Access</p></td>
<td><p>Sends a notification when any of the specified security detections occur based on an Internet Access control rule</p>
<p>For more information, see <a href="trend-vision-one-create-internet-access-rule">Creating an internet access rule</a>.</p></td>
</tr>
<tr>
...
<td><p>Sends alerts when any watchlisted risk events at the High or Medium risk level occur</p>
