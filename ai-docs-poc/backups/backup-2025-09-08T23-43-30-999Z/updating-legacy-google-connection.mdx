---
slug: trend-vision-one-updating-legacy-google-connection
title: Updating a legacy Google Cloud connection
last_updated: '2025-09-08'
ai_context:
  source_file: updating-legacy-google-connection.md
  conversion_date: '2025-09-08T23:42:11.746Z'
...
If you have access to the Agentless Vulnerability and Threat Detection feature for Google Cloud, see [Updating a legacy Google Cloud connection (January 2025 update)](update-legacy-google-cloud-project.mdx) to update your Legacy Connection.
...
6.  Verify the **Name** and **Description**, or edit as needed.
