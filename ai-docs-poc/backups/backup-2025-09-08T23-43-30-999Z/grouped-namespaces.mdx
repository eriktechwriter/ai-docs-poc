---
slug: trend-vision-one-grouped-namespaces
title: Grouped namespaces
last_updated: '2025-09-08'
ai_context:
  source_file: grouped-namespaces.md
  conversion_date: '2025-09-08T23:42:18.273Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
View the sets of related namespaces within namespace groups.

When connecting Kubernetes clusters, namespace options with an asterisk (\*) represent sets of related namespaces. The following lists detail the namespaces that comprise these groups.
