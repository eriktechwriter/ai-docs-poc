---
slug: trend-vision-one-adding-computers
title: About adding computers
last_updated: '2025-09-08'
ai_context:
  source_file: adding-computers.md
  conversion_date: '2025-09-08T23:42:25.808Z'
...
The *Computers* page in the Server & Workload Protection console enables you to manage and monitor the computers you are protecting with Server & Workload Protection.
...
### Add computers to Server & Workload Protection {#add-computers-to-server-workload-protection}

:::note

After being installed on a computer, an agent must be activated by Server & Workload Protection. During activation, Server & Workload Protection sends a fingerprint to the agent, after which the agent accepts instructions only from a Server & Workload Protection instance with that unique fingerprint.
:::
...
You can also [Group computers dynamically with smart folders](group-computers-smart-folders.mdx).

### Export your computers list {#export-your-computers-list}
