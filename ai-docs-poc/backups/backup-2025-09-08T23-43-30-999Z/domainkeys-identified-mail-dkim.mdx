---
slug: trend-vision-one-domainkeys-identified-mail-dkim
title: Domainkeys identified mail (DKIM)
last_updated: '2025-09-08'
ai_context:
  source_file: domainkeys-identified-mail-dkim.md
  conversion_date: '2025-09-08T23:42:20.358Z'
...
Cloud Email Gateway Protection implements DKIM authentication only in the following scenarios:
...
- [Adding DKIM verification settings](adding-dkim-verification-settings.mdx)
- [Editing DKIM verification settings](editing-dkim-verification-settings.mdx)
- [Adding DKIM signing settings](adding-dkim-signing-settings.mdx)
- [Editing DKIM signing settings](editing-dkim-signing-settings.mdx)
:::
