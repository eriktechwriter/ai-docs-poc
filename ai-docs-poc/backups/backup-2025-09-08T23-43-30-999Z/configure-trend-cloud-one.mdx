...
title: Configure Trend Cloud One
last_updated: '2025-09-08'
ai_context:
  source_file: configure-trend-cloud-one.md
  conversion_date: '2025-09-08T23:42:22.634Z'
...
After connecting Trend Cloud One, Endpoint & Workload Security is no longer available in theTrend Cloud One environment and all endpoint management is transferred to Trend Vision One in Server & Workload Protection and Endpoint Inventory.
:::
...
2.  Use the enrollment token to integrate your Trend Cloud One environment with Trend Vision One.
    ...
    4.  Paste the enrollment token and click **Register**.
        ...
        After connecting Trend Cloud One, Endpoint & Workload Security is no longer available in the Trend Cloud One environment and all endpoint management is transferred to Trend Vision One in Server & Workload Protection and Endpoint Inventory.
        :::
