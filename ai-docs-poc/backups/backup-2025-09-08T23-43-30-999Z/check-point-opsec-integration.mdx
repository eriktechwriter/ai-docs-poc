...
ai_context:
  source_file: check-point-opsec-integration.md
  conversion_date: '2025-09-08T23:42:23.920Z'
...
2.  Configure settings on Trend Vision One.
    ...
    5.  Under **Data Transfer**, configure data sharing criteria and integration settings.
        ...
        1.  **Frequency**: Select the frequency for sharing suspicious object data.
