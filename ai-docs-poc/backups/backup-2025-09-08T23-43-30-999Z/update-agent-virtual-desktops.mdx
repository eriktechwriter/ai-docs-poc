...
ai_context:
  source_file: update-agent-virtual-desktops.md
  conversion_date: '2025-09-08T23:42:11.825Z'
...
To update your golden image, you must have a snapshot of the source desktop created before running the Image Setup Tool and exporting the golden image. If you do not have a snapshot available, follow the steps in [Creating a golden image with the agent software](create-golden-agent-image.mdx) to create a new snapshot and golden image.
