...
ai_context:
  source_file: adding-managing-domains.md
  conversion_date: '2025-09-08T23:42:25.729Z'
...
Verifying your organization's domains with Trend Micro is required for the function of several Trend Vision One [apps and services](domain-verification.mdx).
