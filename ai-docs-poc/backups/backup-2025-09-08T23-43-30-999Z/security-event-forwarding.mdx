...
title: Security event forwarding (legacy)
last_updated: '2025-09-08'
ai_context:
  source_file: security-event-forwarding.md
  conversion_date: '2025-09-08T23:42:12.991Z'
...
- Security Event Forwarding requires a [Service Gateway API key](service-gateway-management.mdx). To obtain the key, go to **Workflow and Automation → Service Gateway Management** and click **Manage API Key**.
