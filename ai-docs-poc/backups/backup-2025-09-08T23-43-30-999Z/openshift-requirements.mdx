---
slug: trend-vision-one-openshift-requirements
title: OpenShift requirements
last_updated: '2025-09-08'
ai_context:
  source_file: openshift-requirements.md
  conversion_date: '2025-09-08T23:42:14.722Z'
...
- For ArgoCD deployments, OpenShift namespaces must be manually added to the overrides file, regardless of the Helm chart version.
