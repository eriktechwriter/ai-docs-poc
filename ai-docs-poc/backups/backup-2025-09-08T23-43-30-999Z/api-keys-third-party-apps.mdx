...
ai_context:
  source_file: api-keys-third-party-apps.md
  conversion_date: '2025-09-08T23:42:24.938Z'
...
To ensure that only authorized applications can gain access to your Trend Vision One data, you must create a user account specifically configured to allow API usage. For more information, see [Configure accounts](configure-vision-accounts.mdx).
