---
slug: trend-vision-one-manual-scan-targets
title: 'Manual Scan: Target Tab'
last_updated: '2025-09-08'
ai_context:
  source_file: manual-scan-targets.md
  conversion_date: '2025-09-08T23:42:16.100Z'
...
2.  In the **Scan Settings** section, configure the required settings.
    ...
    <tbody>
    <tr>
    <td><p><strong>Scan hidden folders</strong></p></td>
    <td><p>Allows the Trend Vision One Endpoint Security agent to detect and then scan hidden folders on the endpoint</p></td>
    </tr>
    <tr>
    <td><p><strong>Scan network drive</strong></p></td>
    <td><p>Scans directories physically located on other endpoints, but mapped to the local endpoint</p></td>
    </tr>
    <tr>
