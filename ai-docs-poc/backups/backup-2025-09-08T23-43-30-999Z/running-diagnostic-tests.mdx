...
ai_context:
  source_file: running-diagnostic-tests.md
  conversion_date: '2025-09-08T23:42:13.353Z'
...
3.  Run the diagnostic test on the desired endpoints.
    ...
    1.  Use the search field to locate the endpoints to diagnose.
        ...
        You can search endpoints by name, IP address or [agent GUID](finding-endpoint-information.mdx).
    ...
    You can monitor diagnostic tests in the [Test Results](test-results-tab.mdx) tab.
    :::
