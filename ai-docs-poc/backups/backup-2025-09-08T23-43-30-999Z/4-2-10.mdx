---
slug: trend-vision-one-4-2-10
title: >-
  4.2.10 - Ensure that the –rotate-certificates argument is not set to false
  (Automated)
last_updated: '2025-09-08'
ai_context:
  source_file: 4-2-10.md
  conversion_date: '2025-09-08T23:42:26.311Z'
...
This feature also requires the `RotateKubeletClientCertificate` feature gate to be enabled (which is the default since Kubernetes v1.7)
:::
