---
slug: trend-vision-one-unblock-cloud-app-url-access-task
title: 'Unblock AI Service, Cloud App, or URL Access task'
last_updated: '2025-09-08'
ai_context:
  source_file: unblock-cloud-app-url-access-task.md
  conversion_date: '2025-09-08T23:42:11.872Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
After resolving the risk issues on the user account, you can allow the user account to access cloud apps and websites using the **Zero Trust Secure Access** or **Threat and Exposure Management** app.

### Procedure {#procedure}

1.  Locate the user account using the **Zero Trust Secure Access** or **Threat and Exposure Management** app.
...
2.  Click the options icon (![](/images/options_icon=1b2aff71-0b33-4aa1-b8aa-6105438834e7.webp)) and **Unblock Cloud App/URL Access**.

    The **Unblock Cloud App/URL Access Task** screen appears.
