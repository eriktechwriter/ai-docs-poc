---
slug: trend-vision-one-managed-product-unreachable
title: Managed Product Unreachable
last_updated: '2025-09-08'
ai_context:
  source_file: managed-product-unreachable.md
  conversion_date: '2025-09-08T23:42:16.187Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
Configure the following event notification to notify administrators when a connection error occurs between Trend Micro Apex Central and a managed product server.
