...
ai_context:
  source_file: configure-wrs-server-workload.md
  conversion_date: '2025-09-08T23:42:22.612Z'
conversion_status: converted
translation_ready: true
---

:::: {role="main"}
Configure the Web Reputation module to define its behavior for a policy. When designing the module’s behavior and implementing it using the API, use the background information and guidance that is provided in [Block access to malicious URLs with Web Reputation](configure-web-reputation.mdx).
