...
ai_context:
  source_file: cortex-xsoar-integration.md
  conversion_date: '2025-09-08T23:42:21.649Z'
...
For more information, see [Creating a User Role for Cortex XSOAR Integration](user-role-cortex-xsoar.mdx).
:::
