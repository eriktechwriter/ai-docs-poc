---
slug: trend-vision-one-attachment-true-file-type
title: Using attachment true file type criteria
last_updated: '2025-09-08'
ai_context:
  source_file: attachment-true-file-type.md
  conversion_date: '2025-09-08T23:42:24.749Z'
...
5.  Select the true file types for Cloud Email Gateway Protection to match on.

    :::note

    - For Microsoft Office files of version 2007 or later, Cloud Email Gateway Protection supports attachment true file type detection only when the files are not encrypted.
