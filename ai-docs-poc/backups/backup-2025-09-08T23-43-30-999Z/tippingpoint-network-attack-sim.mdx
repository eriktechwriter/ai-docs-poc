...
ai_context:
  source_file: tippingpoint-network-attack-sim.md
  conversion_date: '2025-09-08T23:42:12.026Z'
...
For more details on connecting a TippingPoint SMS to Trend Vision One, see [TippingPoint SMS connection guides](tippingpoint-sms-connection-guides.mdx).
...
3.  Wait 5-10 minutes and then view the results.
    ...
    - In **Workbench**:
      ...
      1.  On the Trend Vision One console, go to **Agentic SIEM & XDR → Workbench**.
    ...
    - In **Observed Attack Techniques**:
      ...
      1.  On the Trend Vision One console, go to **Agentic SIEM & XDR → Observed Attack Techniques**.
