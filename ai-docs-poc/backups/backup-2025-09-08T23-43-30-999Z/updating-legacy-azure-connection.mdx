---
slug: trend-vision-one-updating-legacy-azure-connection
title: Updating a legacy Azure connection
last_updated: '2025-09-08'
ai_context:
  source_file: updating-legacy-azure-connection.md
  conversion_date: '2025-09-08T23:42:11.748Z'
...
4.  Click the name of the legacy connection subscription you want to update.
    ...
    The **Subscription Settings** screen opens to the **Subscription Information** tab.

5.  Verify the **Subscription ID**, **Name**, and **Description** or edit as needed.

6.  Configure the features and permissions as needed. For more information, see [Azure features and permissions](azure-features-permissions.mdx).

7.  In Azure Cloud Shell, access the command line interface.

8.  Access the subscription you want to update. Type the command `az login` and follow the instructions to finish the initial account sign-in.

9.  Create a new directory for the deployment folder and then access the folder.
...
10. Upload the resource creation script to your Azure Cloud Shell.
...
11. Extract the template using the command in the **Subscription Settings** screen.
...
12. Access the deployment folder.
