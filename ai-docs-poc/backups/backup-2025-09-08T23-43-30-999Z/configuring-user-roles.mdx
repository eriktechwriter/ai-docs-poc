...
ai_context:
  source_file: configuring-user-roles.md
  conversion_date: '2025-09-08T23:42:22.063Z'
...
Follow these steps to create custom user roles or try and use the [predefined roles](predefined-roles-trend-vision-one.mdx).
