...
ai_context:
  source_file: greenbone-integration.md
  conversion_date: '2025-09-08T23:42:18.300Z'
...
1.  Configure the Greenbone Management Protocol (GMP) on your Greenbone Enterprise Appliance.
    ...
    6.  Select **OK** and press **Enter** to save your changes.
        ...
        For more information, see the [Greenbone Enterprise Appliance documentation](https://docs.greenbone.net/GSM-Manual/gos-22.04/en/managing-gos.mdx).

2.  In Trend Vision One, go to **Workflow and Automation → Third-Party Integration**.

3.  In the **Integration** column, click **Greenbone**.

    The **Greenbone** integration screen appears.

4.  If no Service Gateway is available, click the **Service Gateway Management** link to [deploy a Service Gateway](deployment-guides.mdx) or enable the Greenbone Connector service on an existing Service Gateway.
