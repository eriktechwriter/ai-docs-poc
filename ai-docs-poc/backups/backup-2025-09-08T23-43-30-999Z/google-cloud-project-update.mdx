---
slug: trend-vision-one-google-cloud-project-update
title: Google Cloud Resource Update (January 2025 update)
last_updated: '2025-09-08'
ai_context:
  source_file: google-cloud-project-update.md
  conversion_date: '2025-09-08T23:42:18.750Z'
...
The Resource Update tab in the Project Settings screen allows you to update the Trend Vision One resources deployed to your project. Updating might be required to support new features or functions added to Cloud Accounts. Make sure you have the [required permissions](gcp-required-permissions.mdx) to update the project.

Some features have limited support for Google Cloud regions. For more information, see [Google Cloud supported regions and limitations](google-supported-regions.mdx).

:::warning[Important]

The following steps are for updating resources on a connected project. To update a Legacy Connection, see [Updating a legacy Google Cloud connection (January 2025 update)](update-legacy-google-cloud-project.mdx).
...
The January 2025 update is not available in all regions. To check which version you have, verify if you have access to the Agentless Vulnerability & Threat Detection feature. If not, see [Google Cloud Resource Update](resource-update-gcp.mdx) to update your deployed resources.
