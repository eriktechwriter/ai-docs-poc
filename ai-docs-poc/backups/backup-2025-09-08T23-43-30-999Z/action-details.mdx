...
ai_context:
  source_file: action-details.md
  conversion_date: '2025-09-08T23:42:26.201Z'
...
In the **Actions** section of the [Execution details](execution-details.mdx) screen, clicking **Check details** in a listed node opens the **Action Details** screen, which tallies and lists the status of the action for each target of the selected node.
