---
slug: trend-vision-one-wn-new-credit-calculator
title: Estimate your credit requirements with the new credit calculator
last_updated: '2025-09-08'
ai_context:
  source_file: wn-new-credit-calculator.md
  conversion_date: '2025-09-08T23:42:11.468Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
August 4, 2025—The new credit calculator is now available in **Credits & Billing**. This tool allows you to estimate your credit requirements based on projected usage of selected solutions. You can easily determine how many credits you need overall, without doing any calculations.
...
For more information, see [Credits & Billing](credits-billing.mdx).
