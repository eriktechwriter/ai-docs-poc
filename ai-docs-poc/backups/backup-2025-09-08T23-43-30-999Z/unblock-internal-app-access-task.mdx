---
slug: trend-vision-one-unblock-internal-app-access-task
title: Unblock Internal App Access task
last_updated: '2025-09-08'
ai_context:
  source_file: unblock-internal-app-access-task.md
  conversion_date: '2025-09-08T23:42:11.871Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
After resolving the risk issues on the user account, you can allow the user account to access your internal apps using the **Zero Trust Secure Access** or **Threat and Exposure Management** app.
...
2.  Click the options icon (![](/images/options_icon=1b2aff71-0b33-4aa1-b8aa-6105438834e7.webp)) and **Unblock Internal App Access**.

    The **Unblock Internal App Access Task** screen appears.
