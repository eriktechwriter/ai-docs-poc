---
slug: trend-vision-one-cegp-mail-tracking-logs-v1-2
title: Mail tracking logs for accepted traffic integrated with Trend Vision One
last_updated: '2025-09-08'
ai_context:
  source_file: cegp-mail-tracking-logs-v1-2.md
  conversion_date: '2025-09-08T23:42:24.027Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
June 17, 2025—Cloud Email Gateway Protection now supports uploading mail tracking logs for the accepted traffic type to Trend Vision One. This enhancement allows customers to:
