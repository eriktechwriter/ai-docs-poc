...
title: Configure Deep Security Software
last_updated: '2025-09-08'
ai_context:
  source_file: configure-deep-security-software.md
  conversion_date: '2025-09-08T23:42:22.798Z'
...
The connection process only transfers information related to the product instance and base agents, but not existing XDR Endpoint Sensors. Contact your support representative to find out [how to move Endpoint Sensor agents and any limitations](endpoint-inventory-updates.mdx) that might impact your network.
...
3.  Paste the enrollment token to the Deep Security software.
    ...
    1.  On the Deep Security console, go to **Administration → System Settings → Trend Vision One**.
