...
ai_context:
  source_file: remote-shell-windows-endpoints.md
  conversion_date: '2025-09-08T23:42:13.871Z'
...
<td><p>Lists drives with details</p>


:::note

<p>User Account Control (UAC) may prevent users from accessing network drives mounted by other user accounts. To address this, the system retrieves drive information based on currently active local users. If multiple users are logged in concurrently, the system collects and displays drive information for the active local user who most recently logged in.</p>
...
<p>Downloading suspicious samples may potentially harm your endpoint. Take necessary precautions before continuing. Trend Vision One automatically stores the collected samples in a password-protected .zip archive.</p>
