---
slug: trend-vision-one-swp-agent-deploy-microsoft-intune
title: Server & Workload Protection Agent Deployment using Microsoft Intune
last_updated: '2025-09-08'
ai_context:
  source_file: swp-agent-deploy-microsoft-intune.md
  conversion_date: '2025-09-08T23:42:12.197Z'
...
20. Click **Add** to add new detection rules.
    ...
    <li><p><strong>Detection method</strong>: Select <strong>Value exists</strong>.</p></li>
    <li><p><strong>Associated with a 32-bit ap on 64-bit clients</strong>: Select <strong>No</strong>.</p></li>
    </ul></td>
    </tr>
    <tr>
    <td><p>File</p></td>
