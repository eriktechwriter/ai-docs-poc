---
slug: trend-vision-one-eks-clusters-without-fargate
title: Connect Amazon EKS clusters (with and without Fargate)
last_updated: '2025-09-08'
ai_context:
  source_file: eks-clusters-without-fargate.md
  conversion_date: '2025-09-08T23:42:20.254Z'
...
2.  Select the **Amazon EKS** node in the tree.
...
6.  If you want Container Security to send data to Cloud Risk Management and receive [CREM Risk Insights](executive-dashboard.mdx), select **Map to cloud account**.
    ...
    1.  In the dropdown menu, select **AWS**.
...
- [Amazon EKS Fargate system requirements](amazon-eks-fargate-sys-reqs.mdx)
::::
