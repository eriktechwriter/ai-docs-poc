...
ai_context:
  source_file: execution-results.md
  conversion_date: '2025-09-08T23:42:19.549Z'
...
For customers that have updated to the [Foundation Services release](update-foundation-services-release.mdx), execution results might not be visible if there are no endpoints within the asset visibility scope of the user who executed the playbook.
:::
