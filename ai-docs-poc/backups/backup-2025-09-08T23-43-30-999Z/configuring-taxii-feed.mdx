---
slug: trend-vision-one-configuring-taxii-feed
title: Configuring a TAXII feed
last_updated: '2025-09-08'
ai_context:
  source_file: configuring-taxii-feed.md
  conversion_date: '2025-09-08T23:42:22.104Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
You can add or edit a [TAXII feed](https://help.eset.com/eti_portal/en-US/taxii_feeds.mdx) that you want to subscribe to.

### Procedure {#procedure}

1.  Go to **Threat Intelligence → Third-Party Intelligence → TAXII Feeds**.

    The **TAXII Feeds** screen appears.

2.  Add or edit a TAXII feed.

    - To add a feed, click **Add**.

    - To edit a feed, click the feed name.

3.  In the **General** section, complete the following settings:
...
4.  In the **Collections** section, complete the following settings:
    ...
    2.  For each selected collection, click the toggle to enable or disable the **Extract and block suspicious objects** option.
        ...
        For an enabled option, click ![](/images/edit_icon=e867c8bf-3c64-4b15-95f5-bf7a76d585ef.webp) and select one or more of the following suspicious object types to extract from the TAXII feed collections and add to the Suspicious Object List:
        ...
        By default, Trend Vision One Threat Intelligence adds only [STIX](https://docs.oasis-open.org/cti/stix/) indicator objects that are not revoked and have any of the following labels to the Suspicious Object List:
        ...
        To specify included labels, go to **Threat Intelligence → Suspicious Object Management → Default settings**
...
5.  In the **Polling criteria** section, complete the following settings:
...
6.  Click **Save**.
    ...
    The TAXII feed appears in **TAXII Feeds** for use in custom intelligence reports. To review the reports generated from your feed subscriptions, go to **Threat Intelligence → Intelligence Reports** and click the **Custom** tab.
:::
