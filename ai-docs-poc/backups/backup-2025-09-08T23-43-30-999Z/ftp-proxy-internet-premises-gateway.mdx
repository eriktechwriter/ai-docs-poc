---
slug: trend-vision-one-ftp-proxy-internet-premises-gateway
title: Enable FTP proxy on an Internet Access On-premises gateway
last_updated: '2025-09-08'
ai_context:
  source_file: ftp-proxy-internet-premises-gateway.md
  conversion_date: '2025-09-08T23:42:19.020Z'
...
2.  On the **Gateways** tab, select **Forward proxy** for Service mode.

3.  Click the edit icon for the **Location** to which you want to add the FTP Proxy.

4.  In Advance Settings on the Corporate intranet location setting module, under FTP traffic, select **Enable FTP Proxy (Port 8021)**.
...
5.  Select the mode and click **Save**.
::::
