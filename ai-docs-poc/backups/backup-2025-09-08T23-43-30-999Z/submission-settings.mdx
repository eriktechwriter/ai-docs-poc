...
ai_context:
  source_file: submission-settings.md
  conversion_date: '2025-09-08T23:42:12.269Z'
...
<tr>
<td><p>Use Deep Discovery Analyzer instead of the Sandbox Analysis sandbox</p></td>
<td><p>Select <strong>Use your Deep Discovery Analyzer instead of the Sandbox Analysis sandbox</strong> to submit objects to your connected Deep Discovery Analyzer.</p>


:::warning[Important]

<p>Multiple Deep Discovery Analyzer appliances can be connected to Trend Vision One at the same time, and samples can be received by any of the connected appliances. However, Sandbox Analysis currently does not support specifying which Deep Discovery Analyzer appliance analyzes submissions.</p>
