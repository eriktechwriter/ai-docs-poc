---
slug: trend-vision-one-cis-aks17-312
title: >-
  3.1.2 - Ensure that the kubelet kubeconfig file ownership is set to root:root
  (Automated)
last_updated: '2025-09-08'
ai_context:
  source_file: cis-aks17-312.md
  conversion_date: '2025-09-08T23:42:23.874Z'
...
5.  Verify that if a file is specified and it exists, the ownership is `root:root`.
