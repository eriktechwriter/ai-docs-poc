...
ai_context:
  source_file: microsoft-power-bi-integration.md
  conversion_date: '2025-09-08T23:42:16.041Z'
...
2.  In Power BI Desktop, configure and run the downloaded Python script to import data.
    ...
    When running the downloaded Python script in your Power BI Desktop, replace 'TOKEN' with the authentication token obtained from the previous step.
