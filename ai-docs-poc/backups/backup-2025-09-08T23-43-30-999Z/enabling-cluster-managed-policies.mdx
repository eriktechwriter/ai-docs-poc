---
slug: trend-vision-one-enabling-cluster-managed-policies
title: Enabling cluster-managed policies
last_updated: '2025-09-08'
ai_context:
  source_file: enabling-cluster-managed-policies.md
  conversion_date: '2025-09-08T23:42:20.064Z'
conversion_status: converted
translation_ready: true
---

:::::: {role="main"}
Use the following commands and examples to create the cluster policy and runtime ruleset custom resources for your cluster-managed policies in Container Inventory.
...
### Apply policy to cluster {#apply-policy-to-cluster}

For information on the rules, exceptions, and XDR enablement resources that you can apply to your cluster managed policy, see [Custom resources for cluster-managed policies](custom-resources-cluster-manag.mdx).
...
### Custom resource ruleset {#custom-resource-ruleset}
...
- **ruleID**: The Trend Micro runtime ruleID as `TM-{8 digit id}` (example: TM-00000001). [View the list of available, predefined rules](predefined-rules.mdx).
