...
ai_context:
  source_file: network-content-inspection-engine.md
  conversion_date: '2025-09-08T23:42:15.624Z'
...
The Network Content Inspection Engine for Endpoint Sensor only supports Windows 64-bit (x86-64) environments.

Functionality is limited for operating systems older than Windows 10 and Windows Server 2019.

For Standard Endpoint Protection deployments, the Network Content Inspection Engine for Endpoint Sensor operates cocurrently with Network Content Inspection Engine for Standard Endpoint Protection.
:::
