---
slug: trend-vision-one-notes-resource-property-values
title: Notes about resource property values
last_updated: '2025-09-08'
ai_context:
  source_file: notes-resource-property-values.md
  conversion_date: '2025-09-08T23:42:15.080Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
There are a few things that you should be aware of when setting values for resource properties or Server & Workload Protection settings.

### How to express a null value {#how-to-express-a-null-value}
...
### Valid values for Boolean properties {#valid-values-for-boolean-properties}
...
### Include only changed values when modifying resources {#include-only-changed-values-when-modifying-resources}
