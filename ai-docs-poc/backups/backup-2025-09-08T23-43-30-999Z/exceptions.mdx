...
ai_context:
  source_file: exceptions.md
  conversion_date: '2025-09-08T23:42:19.581Z'
...
- [Custom exceptions](adding-custom-exception.mdx): Originate from **Detection Model Management**. Custom exceptions use target, event source, and match criteria to define the objects and events to exclude from detections.

- [Context menu exceptions](adding-exception-context-menu.mdx): Originate from the context menu in **Workbench** and **Observed Attack Techniques**. Context menu exceptions use the detection model filter and match criteria to define the objects and events to exclude from detections.
