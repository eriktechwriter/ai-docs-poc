...
title: Configure OneLogin
last_updated: '2025-09-08'
ai_context:
  source_file: configuring-onelogin.md
  conversion_date: '2025-09-08T23:42:22.303Z'
...
5.  Add OneLogin as an IdP in the Trend Vision One **Identity Providers** app.
    ...
    5.  Click **Save**.
        ...
        [Added SAML users](adding-saml-account.mdx) receive an account verification email from Trend Vision One. After clicking **Verify Email** in the email, users can sign in to Trend Vision One using their OneLogin credentials.
:::
