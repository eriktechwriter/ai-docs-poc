...
ai_context:
  source_file: xdr-data-retention.md
  conversion_date: '2025-09-08T23:42:11.416Z'
conversion_status: converted
translation_ready: true
---

::: {role="main"}
Trend Vision One offers data retention [licenses](license-information.mdx) for XDR-related data:
...
The default period for these apps is 30 days of data retention for **XDR Data Explorer** and [Observed Attack Techniques](observed-attack-techniques.mdx). You can extend the retention period to 90 days, 180 days, or one year with the purchase of the applicable license.

The XDR data retention period refers to the following:

- The length of time that Trend Vision One retains logs and during which you can find these logs using **XDR Data Explorer**.
...
- [Mobile Security](mobile-security.mdx) including detection and activity logs: 180 days

- [Email and Collaboration Security](get-start-email-collaboration.mdx) including detection and activity logs for both the [Email and Collaboration Sensor](email-sensor.mdx) and connected point products like [Cloud App Security](https://docs.trendmicro.com/en-us/documentation/article/cloud-app-security-online-help-introduction): 180 days

- [Zero Trust Secure Access](zero-trust-secure-access-overview.mdx) including detection and activity logs: 180 days

- [Container Security](container-security.mdx) including detection and activity logs: 30 days
...
- [Cloud One - Network Security](https://docs.trendmicro.com/en-us/documentation/article/trend-micro-cloud-one-network-security-Getting_started) point product detection logs only: 30 days
