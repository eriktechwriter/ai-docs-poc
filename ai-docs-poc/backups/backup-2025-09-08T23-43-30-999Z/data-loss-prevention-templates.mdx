---
slug: trend-vision-one-data-loss-prevention-templates
title: Data Loss Prevention Templates
last_updated: '2025-09-08'
ai_context:
  source_file: data-loss-prevention-templates.md
  conversion_date: '2025-09-08T23:42:20.873Z'
...
You can create your own templates if you have configured DLP data identifiers. You can also use predefined templates. For details, see [Custom DLP templates](custom-dlp-templates.mdx) and [Predefined DLP Templates](predefined-dlp-templates.mdx).
...
- [Predefined DLP Templates](predefined-dlp-templates.mdx)
- [Custom DLP templates](custom-dlp-templates-2.md "Create your own DLP templates if you have configured data identifiers.")
::::
