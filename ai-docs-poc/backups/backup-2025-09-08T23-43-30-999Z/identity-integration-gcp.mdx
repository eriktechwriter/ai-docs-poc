...
ai_context:
  source_file: identity-integration-gcp.md
  conversion_date: '2025-09-08T23:42:17.845Z'
...
<p>For more information, see <a href="trend-vision-one-gcp-identity-integration">Configuring Google Cloud Identity integration</a> and <a href="trend-vision-one-config-google-cloud-saml">Configure Google Cloud Identity</a>.</p>
