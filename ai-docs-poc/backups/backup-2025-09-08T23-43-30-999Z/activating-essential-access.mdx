...
title: Activate Trend Vision One with Essential Access
last_updated: '2025-09-08'
ai_context:
  source_file: activating-essential-access.md
  conversion_date: '2025-09-08T23:42:26.115Z'
...
Trend Micro provisions a Trend Vision One console with Essential Access apps and features to customers with valid licenses for [supported on-premises and SaaS products](essential-access.mdx). The expiration date of the Trend Vision One console aligns with the expiration date of the supported license that expires last.
