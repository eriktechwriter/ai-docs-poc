---
slug: trend-vision-one-adding-azure-management-group
title: Adding an Azure Management Group
last_updated: '2025-09-08'
ai_context:
  source_file: adding-azure-management-group.md
  conversion_date: '2025-09-08T23:42:25.811Z'
...
7.  Specify the general information for the Management Group.
    ...
    4.  Select the Azure region for deployment.
        ...
        Some Cloud Account features have limited support for Azure regions. For more information, see [Azure supported regions and limitations](azure-supported-regions-limitations.mdx).
        :::
...
9.  Configure the **Features and Permissions** you want to grant access to your cloud environment. For more information, see [Azure features and permissions](azure-features-permissions.mdx).
...
14. In Azure local shell, access the command line interface and enter the resource creation script you copied in the previous step. This downloads the script directly to your cloud environment.
...
17. Initiate Terraform and run the resource creation script.
    ...
    Azure local shell begins the terraform process to deploy Trend Vision One security resources.

18. In the Trend Vision One console, click **Done**.

**Related information**

- [Azure script to change the primary subscription](azure-change-primary-subscription.mdx)
:::
