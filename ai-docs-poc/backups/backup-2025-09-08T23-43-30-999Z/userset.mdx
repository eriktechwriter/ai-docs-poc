---
slug: trend-vision-one-userset
title: UserSet
last_updated: '2025-09-08'
ai_context:
  source_file: userset.md
  conversion_date: '2025-09-08T23:42:11.682Z'
...
- *passwordLastChanged*: The timestamp of the last time the user's password was changed. This is recorded by the agent as the number of milliseconds since Jan 1 1970 UTC. Server & Workload Protection renders the timestamp in local time based on this value. Note that on Unix platforms, the resolution of this attribute is one day, so the time component of the rendered timestamp is meaningless. (Not supported by AIX.)
...
### Windows-only Attributes {#windows-only-attributes}
...
### Linux, AIX, and Solaris Attributes {#linux-aix-and-solaris-attributes}
...
### Special attributes of Include and Exclude for UserSets {#special-attributes-of-include-and-exclude-for-usersets}
