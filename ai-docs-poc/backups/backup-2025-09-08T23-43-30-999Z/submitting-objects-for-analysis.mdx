...
ai_context:
  source_file: submitting-objects-for-analysis.md
  conversion_date: '2025-09-08T23:42:12.266Z'
...
3.  Select the object type.
    ...
    - **File**
      ...
      1.  Click **Select** and locate a file for submission.
          ...
          - The sandbox only analyzes [supported file types](supported-file-types.mdx).
...
4.  Click **Submit Object**.
    ...
    The sandbox may not be able to analyze an object for [various reasons](reasons-for-analysis-failure.mdx).
    :::
::::
